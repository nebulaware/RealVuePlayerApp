...
this.GetContent = function GetContent(type){
...
var Bundler = new BundlerManager();

App.AddComponent(Bundler); //Needed for AJAX Calls
Presenter.AddSource(Bundler); //Needed for Presenter